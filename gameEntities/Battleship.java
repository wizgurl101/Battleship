...
/**
 * Battleship class holds the ship name, ship color, row and columns values of the ship location on the fleet board, ship orientation and
 * the ship health.
 * @author Nhu Phan
...
public class Battleship extends Ship {
	...
	private static int[] startingRows = {8, 8, 8, 8};
	private static int[] startingCols = {3, 4, 5, 6};
	private static String startingOrientation = "horizontal";
	private static int startingShipHealth = 4;
	 ...
	 */
	public Battleship(String shipName, int[] rows, int[] cols, Color shipColor, String orientation, int shipHealth) {
