...
/**
 * Destroyer class holds the ship name, ship color, row and columns values of the ship location on the fleet board, ship orientation and
 * the ship health.
 * @author Nhu Phan
...
public class Destroyer extends Ship {
	...
	private static final Color SHIP_COLOR = new Color(255, 204, 0); // is a dark yellow color
	
	// Initialize values for the location and ship health for when the player board first is generated
	private static int[] startingRows = {2, 2};
	private static int[] startingCols = {3, 4};
	private static String startingOrientation = "horizontal";
	private static int startingShipHealth = 2;
	 ...
	 */
	public Destroyer(String shipName, int[] rows, int[] cols, Color shipColor, String orientation, int shipHealth) {
